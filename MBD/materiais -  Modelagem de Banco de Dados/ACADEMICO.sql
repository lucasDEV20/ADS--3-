...
SELECT distinct contatos.con_telefone  FROM contatos
...
SELECT distinct disciplinas.dis_nome  FROM disciplinas
---ALUI0
SELECT  * from alunos_disciplinas 
SELECT distinct alunos_disciplinas.adi_alu_iden  FROM alunos_disciplinas
--join + distinct
SELECT distinct alu.alu_nome,con.con_telefone, dis.dis_nome
                         FROM alunos alu 
...
INSERT INTO alunos_disciplinas VALUES(5 , 10, 5, 4);
INSERT INTO alunos_disciplinas VALUES(6 , 10, 6, 5);
...
SELECT distinct * FROM alunos alu join contatos con ON alu_iden = con_alu_iden
------------------------------------------------------------------                          
SELECT * FROM alunos
--REMOVER ALUNO;
